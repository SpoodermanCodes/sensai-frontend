...
import GenerateAssessmentDialog, { GeneratedQuestion } from "./GenerateAssessmentDialog";
...
const QuizEditor = forwardRef<QuizEditorHandle, QuizEditorProps>(({
    ...
    // State for generate assessment dialog
    ...
    // Handle a question generated by the AI assessment generator
    const handleUseGeneratedQuestion = useCallback((generated: GeneratedQuestion) => {
        const inputType: 'text' | 'code' | 'audio' =
            generated.question_type === 'coding' ? 'code' : 'text';
        const questionType: 'objective' | 'subjective' =
            generated.question_type === 'objective' ? 'objective' : 'subjective';
        const contentBlocks = [{
            id: `block-${Date.now()}`,
            type: 'paragraph',
            props: {},
            content: [{ type: 'text', text: generated.question_text, styles: {} }],
            children: []
        }];
        const answerBlocks = generated.correct_answer ? [{
            id: `block-ans-${Date.now()}`,
            type: 'paragraph',
            props: {},
            content: [{ type: 'text', text: generated.correct_answer, styles: {} }],
            children: []
        }] : [];
        const newQuestion: QuizQuestion = {
            id: `question-${Date.now()}`,
            ...
            config: {
                ...
                questionType,
                inputType,
                codingLanguages: generated.coding_language ? [generated.coding_language] : [],
                responseType: 'chat',
                title: generated.title,
                correctAnswer: answerBlocks,
        ...
        setIntegrationBlocks([]);
        setNewQuestionAdded(true);
        setTimeout(() => setNewQuestionAdded(false), 800);
        updateCurrentQuestionId(newQuestion.id);
        setActiveEditorTab('question');
